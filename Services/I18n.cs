    ...
    private static readonly Dictionary<string, Dictionary<string, string>> _dict =
        new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["tr"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["PostUrlLabel"] = "POST API'sinin (api.php) URL'si veya dizini",
                ["TokenLabel"] = "Token (EXPECTED_TOKEN)",
                ["CleanupSection"] = "Cleanup_API (INBOX sil)",
                ["CleanupUrlLabel"] = "Cleanup API'sinin (cleanup_api.php) URL'si veya dizini",
                ["CleanupTokenLabel"] = "Token (ADMIN_TOKEN)",
                ...
                ["ReceiveUrlLabel"] = "Read API'sinin (read_api.php) URL'si veya dizini",
